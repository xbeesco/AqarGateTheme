...
<table class="form-table">
    <tbody>
        ...
        <tr>
            <th><label for="brokerage_license_number"><?php esc_html_e('رقم رخصة الوساطة العقارية ( فال )','houzez');?></label></th>
        ...
        <tr>
            ...
            <td><input type="text" name="license_expiration_date" id="license_expiration_date"
