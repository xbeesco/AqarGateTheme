 ...
 * @since 1.0.0
 */
class AqarGate_Properties_Tabs extends Widget_Base {
    ...
    public function get_name() {
        return 'AqarGate_Properties_Tabs';
    }
    ...
    public function get_title() {
        return esc_html__( 'Aqar Properties Ajax Tabs', 'houzez-theme-functionality' );
    }
...
Plugin::instance()->widgets_manager->register( new AqarGate_Properties_Tabs );