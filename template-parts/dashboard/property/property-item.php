	...
	<td class="property-table-actions" data-label="<?php echo esc_html__('Actions', 'houzez'); ?>">
		<div class="dropdown property-action-menu">
			...
			<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                ...
                <?php if( $property_status != 'expired' ||  $property_status != 'canceld') { ?>
				<a class="update-property dropdown-item" data-id="<?php echo intval($post->ID); ?>" data-edit="<?php echo $edit_link; ?>" href="">تحديث الاعلان</a>
                <?php } ?>
                ...
                <a href="" class="draft-property dropdown-item" data-property="<?php echo intval($post->ID); ?>"> 
                	حفظ كمسودة
                </a>
                <?php }  ?>
