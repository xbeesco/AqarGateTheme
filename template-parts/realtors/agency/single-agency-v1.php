...
$user = get_users(array(
    'meta_key' => 'fave_author_agency_id',
...
if( houzez_option('agency_stats', 0) != 0  ) {
    $properties_ids = Houzez_Query::loop_agency_properties_ids();
}
                ...
                <div class="col-lg-9 col-md-9 col-sm-12">
                    ...
                    <div class="agent-profile-header row">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <h1> اسم الوسيط :  <?php the_title(); ?></h1>
                            <h1> رقم رخصة فال :  <?php echo $brokerage_license_number; ?></h1>
                        </div>   
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <h1> تاريخ انتهاء الرخصة :  <?php echo $license_expiration_date; ?></h1>
                        </div>
                            <?php 
